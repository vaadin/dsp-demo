...
[NOTE]
A Menu Bar with checkable items should not be used as a replacement for <<../../inputs/radio-button#,radio buttons>> in a form.
...
* Menu Bar should not be used for navigation. Use <<../../containers/tabs#,tabs>> for switching between content, or <<../anchor#,anchors>> for regular navigation.
* Menu Bar is not an input field. Use <<../../inputs/select#,Select>>, <<../../inputs/combo-box#,Combo Box>>, or <<../../inputs/radio-button#,Radio Button>> instead.
