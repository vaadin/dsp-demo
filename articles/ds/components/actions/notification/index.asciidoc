...
Use a modal <<../../containers/dialog#, Dialog>> in such situations.
...
[source,css]
----
include::{root}/frontend/themes/docs/notification-examples.css[]
----
--
...
|<<../../containers/dialog#, Dialog>>|Dialog should be used instead of Notification for anything that requires immediate user action.
|===
