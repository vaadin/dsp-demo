...
Although functionally similar to <<../../inputs/checkbox#,Checkbox Group>> and <<../../inputs/radio-button#,Radio Button Group>>, List Box is designed to be used as a lightweight scrollable selection list rather than a form input field.
...
|<<../../inputs/checkbox#,Checkbox Group>>
|Input field for selecting multiple options from a list.

|<<../../inputs/combo-box#,Combo Box>>
...
|<<../../inputs/radio-button#,Radio Button Group>>
