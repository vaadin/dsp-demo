...
[source,typescript]
----
include::{root}/frontend/demo/component/confirmdialog/confirm-dialog-basic-preview.ts[render, frame, persistent]
----
--
...
|<<../../containers/dialog#,Dialog>>|Component for presenting information and UI elements in an overlay.
