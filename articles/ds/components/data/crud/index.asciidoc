...
In the meantime, you can view the previous examples for the Java/Flow component.
...
Aside positioning is also a good fit for <<../../layouts/form-layout#,single-column forms>>.
...
// [source,java]
// ----
// include::{root}/src/main/java/com/vaadin/demo/component/crud/CrudEditorContent.java[render,tags=snippet,indent=0,group=Java]
// ----
--
...
// [source,java]
// ----
// include::{root}/src/main/java/com/vaadin/demo/component/crud/CrudGridReplacement.java[render,tags=snippet,indent=0,group=Java]
// ----
--
...
// [source,java]
// ----
// include::{root}/src/main/java/com/vaadin/demo/component/crud/CrudSortingFiltering.java[render,tags=snippet,indent=0,group=Java]
// ----
--
