...
Form Layout sports two columns by default meaning it displays two input fields per line.
On smaller viewports it adjusts to a single column layout.
...
// [source,java]
// ----
// include::../../../../src/main/java/com/vaadin/demo/component/formlayout/FormLayoutColspan.java[render,tags=snippet,indent=0,group=Java]
// ----
...
Forms using this position require more horizontal space which isn't always ideal on narrow viewports.
It's recommended to configure Form Layout to use top-positioned labels on smaller screens.
...
Like the number of columns, *the label position is configurable based on the viewport's width*.
...
Longer forms should be split into smaller, more manageable and user-friendly sections using subheadings, <<../../containers/tabs#,Tabs>>, <<../../containers/details#,Details>> or separate views when possible.
...
For more information, please see the <<../../actions/button#,Button documentation>>.
