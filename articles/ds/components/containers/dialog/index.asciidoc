...
++++
<style>
/* Give enough space for the dialog preview */
.example.merge .render iframe {
  height: 26rem;
...
[source,typescript]
----
include::{root}/frontend/demo/component/dialog/dialog-basic-preview.ts[render, frame, persistent]
----
--
...
Instead, use <<../../actions/notification#,Notifications>> when appropriate.
...
|<<../../actions/confirm-dialog#,Confirm Dialog>>|Dialog for confirming user actions and decisions
